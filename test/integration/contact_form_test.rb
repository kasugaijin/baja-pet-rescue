...
class ContactFormTest < ActionDispatch::IntegrationTest
  test 'All errors and custom messages appear on blank form submission' do
    ...
    assert_select 'div.alert', 'Please fix 3 errors highlighted below.'
    assert_select 'div.alert', "Name can't be blank"
    assert_select 'div.alert', "Email can't be blank"
    assert_select 'div.alert', "Message can't be blank"
  end
